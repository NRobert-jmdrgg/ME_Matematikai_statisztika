function [number_of_wins, number_of_draws, number_of_losses, money_per_round, round_counter] = BlackjackBestStrategyAutoBetStopAfterProfits(number_of_decks, money, percent_profit, sidebet)
    %
    ...
    if money <= (minimum_bet + sidebet.sidebet_amount)
